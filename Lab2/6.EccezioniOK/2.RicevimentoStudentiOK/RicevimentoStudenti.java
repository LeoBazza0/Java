...
public class RicevimentoStudenti {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            while (!(nomeCheck && oraCheck)) { // quando sono diversi
                if (!nomeCheck) {
                    nome = chiediNome();
                }
                if (!oraCheck) {
    ...
    public static void prenota(String[] agenda, int ora, String nome)
        ...
        if ((agenda[ora - STARTING_HOUR] != null))
            throw new ArrayStoreException("L'orario specificato e' gia' allocato per un altro appuntamento");
    ...
    public static int[] orariDisponibili(String[] agenda) throws NullPointerException, IllegalArgumentException {
        ...
        ArrayList<Integer> notBooked = new ArrayList<Integer>();
