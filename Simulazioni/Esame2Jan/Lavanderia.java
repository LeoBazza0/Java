...
public class Lavanderia implements Iterable<Macchina> {
    ...
    public double wash(int id) throws IllegalArgumentException, IndexOutOfBoundsException,
            UnsupportedOperationException, LockException, CreditException {
        // MODIFIES: l[id]
        // EFFECTS: locks l[id], decreases credit by the amount requested for washing,
    ...
    public double dry(int id) throws IllegalArgumentException, IndexOutOfBoundsException, UnsupportedOperationException,
            LockException, CreditException {
        // MODIFIES: l[id]
        // EFFECTS: locks l[id], decreases credit by the amount requested for drying,
        // and returns remaining credit
        // if id < 0 throw IllegalArgumentException
        // if l[id] does not exist throw IndexOutOfBoundsException
