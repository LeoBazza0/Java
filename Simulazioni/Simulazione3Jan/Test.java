            ...
            try {
                switch (in[0]) {
                    case "-":
                        ...
                        break;
                    case "TrattaAereo":
                        p.add(new TrattaAereo(in[1], in[2], Double.parseDouble(in[3]), Double.parseDouble(in[4]),
                                Double.parseDouble(in[6]), Double.parseDouble(in[5])));
                        break;
                    case "TrattaTreno":
                        p.add(new TrattaTreno(in[1], in[2], Double.parseDouble(in[3]), Double.parseDouble(in[4]),
                                Double.parseDouble(in[5])));
                        break;
                    case "TrattaBus":
                        p.add(new TrattaBus(in[1], in[2], Double.parseDouble(in[3]), Double.parseDouble(in[4]),
                                Double.parseDouble(in[5])));
                        break;
                    default:
